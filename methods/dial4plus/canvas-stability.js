(() => {
  'use strict';
  const ids=['axisCanvas','mappingCanvas','recordCanvas','lineageCanvas'];
  ...
  ['resetAxisLayout','resetMappingLayout','resetRecordLayout','resetLineageLayout'].forEach(id=>document.getElementById(id)?.addEventListener('click',()=>setTimeout(stabilize,0)));
})();
