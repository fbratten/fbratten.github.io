(() => {
  'use strict';
  const ids = ['atomCanvas', 'projectionCanvas', 'conformanceCanvas', 'lineageCanvas'];
  ...
  ['resetAtomLayout', 'resetProjectionLayout', 'resetConformanceLayout', 'resetLineageLayout'].forEach(id => {
